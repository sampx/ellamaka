...
7. Commits, Plan state transitions, and user validation follow the workspace dev-flow and user confirmation gates. Do not skip rook, approve, complete, or user confirmation.
