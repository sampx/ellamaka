...
export const dict = {
  ...
  "settings.general.row.reasoningSummaries.title": "預設展開思考過程",
  "settings.general.row.reasoningSummaries.description": "在時間軸中預設展開模型的思考過程內容（關閉時預設摺疊為單行）",

  "settings.general.row.shellToolPartsExpanded.title": "展開工具調用結果",
  "settings.general.row.shellToolPartsExpanded.description": "在時間軸中預設展開工具調用結果",
  "settings.general.row.editToolPartsExpanded.title": "展開編輯工具結果",
  "settings.general.row.editToolPartsExpanded.description": "在時間軸中預設展開 edit、write 和 patch 工具結果",
