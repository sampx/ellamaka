export const dict = {
  ...
  "session.followupDock.withdraw": "Wycofaj",
  ...
  "workbench.chat.reasoning": "Myślenie",
  "workbench.chat.compaction": "Kontekst skompresowany",
  "workbench.chat.retry": "Ponowienie #{{attempt}}",
  "workbench.chat.filesChanged": "pliki: {{count}}",
