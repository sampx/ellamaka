...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ellamaka 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Ellamaka 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Ellamaka 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "prompt.placeholder.design": "随便问点什么，/ 唤起命令，@ 选择智能体...",
  ...
  "prompt.sandbox.label": "沙箱",
  "prompt.sandbox.read-only": "只读",
  "prompt.sandbox.workspace-write": "工作区写入",
  "prompt.sandbox.full-access": "完全访问",
  ...
  "dialog.plugins.empty": "在 settings.jsonc 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Ellamaka 服务器。",
  ...
  "toast.update.description": "Ellamaka 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Ellamaka 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (settings.jsonc) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Ellamaka 暂不支持 MCP 认证。',
  ...
  "notification.session.responseReady.description": "{{agent}} 已回复 · {{time}}",
  ...
  "session.messages.jumpToFirst": "跳转到首条用户消息",
  ...
  "sidebar.gettingStarted.line1": "Ellamaka 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Ellamaka 服务器。",
  ...
  "settings.general.row.theme.description": "自定义 Ellamaka 的主题。",
  ...
  "settings.general.row.fontSize.description": "调整界面全局字体大小（默认：15px）",
  ...
  "settings.general.row.reasoningSummaries.title": "默认展开思考过程",
  "settings.general.row.reasoningSummaries.description": "在时间线中默认展开模型的思考过程内容（关闭时默认折叠为单行）",
  "settings.general.row.shellToolPartsExpanded.title": "展开工具调用结果",
  "settings.general.row.shellToolPartsExpanded.description": "默认在时间线中展开工具调用结果",
  "settings.general.row.editToolPartsExpanded.title": "展开编辑工具结果",
  "settings.general.row.editToolPartsExpanded.description": "默认在时间线中展开 edit、write 和 patch 工具结果",
  ...
  "workbench.view.tui.placeholder": "终端集成即将到来",
  "workbench.view.chat.placeholder": "对话界面即将到来",
  ...
  "workbench.panel.moveSession.title": "移动会话",
  ...
  "workbench.panel.noAvailablePanel": "无可用面板，请先关闭部分会话窗口",
  "workbench.panel.overwriteTitle": "覆盖会话窗口",
  "workbench.panel.overwriteConfirmText": "确定要覆盖面板 #{{index}} 的当前会话吗？",
  "workbench.panel.overwriteConfirmHint": "覆盖后，原有会话将自动解绑并挂起，您可以在左侧会话列表中随时重新恢复。",
  "workbench.tree.deleteConfirmText": "确定要删除会话 \"{{title}}\" 吗？",
  "workbench.tree.deleteConfirmHint": "删除后，该会话记录将从列表中彻底移除。",
  ...
  "workbench.terminal.dock": "终端",
  "workbench.terminal.toggle": "切换终端面板",
  "workbench.terminal.placeholder": "终端集成即将到来",
  "workbench.settings.title": "工作台设置",
  "workbench.settings.appearance": "外观设置",
  "workbench.settings.showTitlebar": "显示标题栏",
  "workbench.settings.showStatusbar": "显示状态栏",
  "workbench.settings.showSpaceRail": "显示空间栏",
  "workbench.status.panels": "{{count}} 个面板",
  "workbench.status.space": "空间",
  "workbench.status.panel": "面板",
  "workbench.status.path": "路径",
  "workbench.status.diagnostics.title": "异常提示中心",
  "workbench.status.diagnostics.retry": "重试",
  "workbench.status.diagnostics.retrying": "重试中…",
  "workbench.status.diagnostics.count": "条消息",
  "workbench.status.diagnostics.clearAll": "清除全部",
  ...
  "workbench.status.sessionArchivedExternally": "会话「{{title}}」已在其他位置归档，已从面板释放",
  ...
  "workbench.status.spaceNotRegistered": "通知对应会话所属的空间已不再登记",
  "workbench.status.sessionUnavailable": "通知对应的会话无法打开（{{reason}}）",
  "workbench.runtime.offline": "服务离线",
  "workbench.runtime.degraded": "事件流重连中",
  "workbench.runtime.recovering": "正在重连",
  "workbench.runtime.offlineOverlay": "连接已断开，正在重连…",
  "workbench.cli.missing": "Wopal CLI 不可用。修复后可恢复空间控制功能（需要 {{required}} 或更高版本）。",
  "workbench.cli.incompatible": "Wopal CLI {{actual}} 不兼容。修复后可恢复空间控制功能（需要 {{required}} 或更高版本）。",
  "workbench.cli.broken": "无法验证 Wopal CLI。修复后可恢复空间控制功能（需要 {{required}} 或更高版本）。",
  "workbench.cli.repair.title": "修复 Wopal CLI",
  "workbench.cli.repair.message": "安装 Wopal CLI {{required}} 或更高版本以恢复空间控制功能？",
  "workbench.cli.repair.hint": "当前会话、聊天、终端和 sidecar 会继续运行。",
  "workbench.cli.repair.confirm": "修复 CLI",
  "workbench.cli.repair.failed": "CLI 修复未完成。请检查网络后重试。",
  "workbench.tree.rename": "重命名",
  "workbench.tree.archive": "归档",
  "workbench.tree.unarchive": "取消归档",
  "workbench.tree.pin": "置顶",
  "workbench.tree.unpin": "取消置顶",
  "workbench.tree.openInNewPanel": "在新面板中打开",
  "workbench.tree.noEmptyPanel": "请先添加面板",
  "workbench.tree.newSession": "新建会话",
  "workbench.tree.details": "会话详情",
  "workbench.tree.detailsDirectory": "目录",
  "workbench.tree.detailsType": "类型",
  "workbench.tree.detailsTypeSpaceRoot": "空间根会话",
  "workbench.tree.detailsTypeProject": "项目仓库会话",
  "workbench.tree.detailsTypeWorktree": "工作树会话",
  "workbench.tree.detailsTypeDirectory": "目录级会话",
  "workbench.tree.detailsTypeGeneral": "通用会话",
  "workbench.tree.detailsBranch": "分支",
  "workbench.tree.detailsRelativePath": "相对路径",
  "workbench.tree.detailsCreated": "创建时间",
  "workbench.tree.detailsUpdated": "更新时间",
  "workbench.tree.detailsSessionId": "会话 ID",
  "workbench.tree.close": "关闭",
  "workbench.tabSwitch.confirm": "当前空间有会话正在运行，切换空间不会中断它们，切回此 Tab 可继续。是否不再提示？",
  "workbench.tabSwitch.dontRemind": "不再提示",
  "workbench.tabClose.title": "关闭空间",
  "workbench.tabClose.confirm": "确定要关闭空间「{{name}}」吗？",
  "workbench.tabClose.desc": "关闭后该空间下的面板布局与运行时资源将被释放：",
  "workbench.tabClose.consequencePanels": "• {{count}} 个面板窗口将被销毁（布局、宽度等）",
  "workbench.tabClose.consequenceSessions": "• {{count}} 个已绑定会话将被解绑（可随时从左侧列表恢复）",
  "workbench.tabClose.consequenceTerminals": "• 正在运行的终端与 TUI 进程将被彻底杀止，无法恢复",
  "workbench.tabClose.confirmButton": "关闭并释放资源",
  "workbench.panelClose.title": "关闭面板会话",
  "workbench.panelClose.confirm": "确定要从面板中关闭会话「{{title}}」吗？",
  "workbench.panelClose.desc": "此操作将释放当前窗口绑定的会话：",
  ...
  "workbench.topbar.selectSpace": "空间",
  "workbench.tree.group.spaceSessions": "空间",
  "workbench.tree.group.projectSessions": "项目",
