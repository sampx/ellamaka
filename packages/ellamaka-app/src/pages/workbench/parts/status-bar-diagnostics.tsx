  ...
  return (
    <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center z-10">
      ...
      >
        ...
        >
          <div class="flex flex-col max-h-[320px] w-full overflow-y-auto">
            <For each={[...list()].reverse()}>
              {(item: DiagnosticMessage) => (
                <div class="flex items-start justify-between gap-2 border-b border-v2-border-border-base py-2 last:border-b-0">
            ...
            <div class="mt-2 flex items-center justify-between border-t border-v2-border-border-base pt-2 text-10-regular">
