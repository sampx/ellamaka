...
// (@wopal/cli-capability-schema), the same TypeBox schemas wopal-cli
// generates its registry from. Compile-time sync: a new required field in
// wopal-cli surfaces here at build time, not at runtime.
// ---------------------------------------------------------------------------
