...
export const Flag = {
  ...
  get OPENCODE_DISABLE_CLAUDE_CODE_PROMPT() {
    return OPENCODE_DISABLE_CLAUDE_CODE || truthy("OPENCODE_DISABLE_CLAUDE_CODE_PROMPT") || truthy("WOPAL_SPACE")
  },
  get OPENCODE_DISABLE_CLAUDE_CODE_SKILLS() {
    return OPENCODE_DISABLE_CLAUDE_CODE || truthy("OPENCODE_DISABLE_CLAUDE_CODE_SKILLS") || truthy("WOPAL_SPACE")
  },
  get OPENCODE_DISABLE_EXTERNAL_SKILLS() {
    return truthy("OPENCODE_DISABLE_EXTERNAL_SKILLS") || truthy("WOPAL_SPACE")
  },
  get OPENCODE_DISABLE_AGENTS_SKILLS() {
    return truthy("OPENCODE_DISABLE_AGENTS_SKILLS") || truthy("WOPAL_SPACE")
  },
