export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Ellamaka",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Ellamaka. ¿Quieres instalarla y reiniciar?",
